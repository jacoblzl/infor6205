...
public class ThreeSumBenchmark {
    ...
    public static void main(String[] args) {
        new ThreeSumBenchmark(100, 10, 10).runBenchmarks();
        new ThreeSumBenchmark(50, 20, 20).runBenchmarks();
        new ThreeSumBenchmark(20, 40, 40).runBenchmarks();
        new ThreeSumBenchmark(10, 80, 80).runBenchmarks();
        new ThreeSumBenchmark(5, 160, 160).runBenchmarks();
        new ThreeSumBenchmark(3, 320, 320).runBenchmarks();
        new ThreeSumBenchmark(2, 640, 640).runBenchmarks();
    }
